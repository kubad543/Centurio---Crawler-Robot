...
int RPWM_Output2 = 10; // Arduino PWM output pin 5; connect to IBT-2 pin 1 (RPWM)
int LPWM_Output2 = 11; // Arduino PWM output pin 6; connect to IBT-2 pin 2 (LPWM)
...
void loop()
{
  ...
  {
    // reverse rotation
    int reversePWM2 = -(sensorValue2 - 511) / 2;
  ...
  {
    // forward rotation
    int forwardPWM2 = (sensorValue2 - 512) / 2;
